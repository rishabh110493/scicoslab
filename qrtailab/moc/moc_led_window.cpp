...
void QRL_LedWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        QRL_LedWindow *_t = static_cast<QRL_LedWindow *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData QRL_LedWindow::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QRL_LedWindow::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_QRL_LedWindow,
      qt_meta_data_QRL_LedWindow, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QRL_LedWindow::getStaticMetaObject() { return staticMetaObject; }
