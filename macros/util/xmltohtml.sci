function xmltohtml(dirs,titles,xsl,step)
	...
	scs_1=grep(%helps(std,1),'man/eng/scicos');
	scs_2=grep(%helps(std,1),'man/fr/scicos');
	scs_3=grep(%helps(std,1),'man\eng\scicos');
	scs_4=grep(%helps(std,1),'man\fr\scicos');
	if size(scs_1,'*')==1 then
          std(scs_1)=[];
        elseif size(scs_2,'*')==1 then
          std(scs_2)=[];
        elseif size(scs_3,'*')==1 then
          std(scs_3)=[];
        elseif size(scs_4,'*')==1 then
          std(scs_4)=[];
        end
