		...
		case 1
			...
			if nc == 3 then
				...
				for i=1:nr
					...
					if DateIn(i,5)<0 | DateIn(i,5)>=60 then
						error('Minute argument must be between 0 and 60');
					end
					
					if DateIn(i,6)<0 | DateIn(i,6)>=60 then
						error('Second argument must be between 0 and 60');
					end
		...
		case 6
			...
			for j=1:nc
				for i=1:nr
					...
					if MinIn(i,j)<0 | MinIn(i,j)>=60 then
						error('The fifth argument must be between 0 and 60');
					end
					
					if SecIn(i,j)<0 | SecIn(i,j)>=60 then
						error('The sixth argument must be between 0 and 60');
					end
