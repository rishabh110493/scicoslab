...
c      double precision stk(*)
c      integer istk(*)
c      real sstk(*)
c      character cstk*(1)
c      complex*16 zstk(*)
c      integer stksizr, stksizg, stklpvar
c      pointer (stkptr, stk)
c      pointer (stkptr, istk)
c      pointer (stkptr, sstk)
c      pointer (stkptr, cstk)
c      pointer (stkptr, zstk)
c      common /stack/ stkptr, stksizr, stksizg, stklpvar
