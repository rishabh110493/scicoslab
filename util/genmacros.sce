...
// used to build a minimal set of macros 
// in order to use genlib.
// This file is used only when compiling 
// macros/util directory see macros/util/buildmacros.sce 
// 
// NOTE THAT THIS FILE IS NO MORE USED.
//------------------------------------
