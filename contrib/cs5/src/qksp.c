...
void qksp(double *a, double *b, double *y,int nd,int nR, int *rutas,
	  double *lambda, double *ppi)
{	
  int pq=0,s,r,cardI0,cardI1,rstar=0,rI1,Newton=0;
  double cosa=0,pi0=0,pi0a=0,pi0b=0,pi=0,fpi,fPpi,zero=1e-10,ci;
  int *pI1=0, cont=0,cont2=0;
