// -*- Mode: scilab -*-
// Main ScicosLab initialisation file
// Copyright INRIA
...
load('SCI/macros/maxplus/lib')
load('SCI/macros/scitexgendoc/auxi/lib')
load('SCI/macros/scitexgendoc/main/lib')
load('SCI/macros/scitexgendoc/util/cos/lib')
load('SCI/macros/scitexgendoc/util/html/lib')
load('SCI/macros/scitexgendoc/util/lang/lib')
load('SCI/macros/scitexgendoc/util/main/lib')
load('SCI/macros/scitexgendoc/util/sci/lib')
load('SCI/macros/scitexgendoc/util/spec/lib')
load('SCI/macros/scitexgendoc/util/str/lib')
load('SCI/macros/scitexgendoc/util/tex/lib')
load('SCI/macros/scitexgendoc/xmltotex/lib')

// Maxplus
//intppty(int(funptr('%talg_a_talg')/100));
typename('talg',257);
typename('mps',261);
[%0,%1,%top,#]=setmaxplus();
...
// this is the compiler we want to use for
// dynamic linking it can be different from the
// BUILD_COMPILER 
...
if ( ~isdef("scicos_pal") | ~isdef("%scicos_menu") | ..
     ...
     ~isdef("%scicos_contrib") | ~isdef("%scicos_libs") | ..
     ~isdef("%scicos_cflags") ) then
...
if MSDOS then
  ...
  clear setmsvc90 setmsvc100 setmsvc90express_old
end
