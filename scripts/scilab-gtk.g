...
{
echo "Usage:"
echo     "ScicosLab <options>"
echo     " "
echo     "      Possible options are:"
echo     "      -args Arguments : passes Arguments to ScicosLab, This Arguments can be retreived"
...
echo     "      -e Instruction  : execute the scicoslab instruction given in Instruction argument."
echo     "                        -e and -f options are mutually exclusive."
echo     "      -f File         : execute the scicoslab script given in File argument."
echo     "                        -e and -f options are mutually exclusive."
